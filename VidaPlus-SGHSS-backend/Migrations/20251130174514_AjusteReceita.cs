...
{
    /// <inheritdoc />
    public partial class AjusteReceita : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogsAuditorias", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConsentLgpd = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Consultas_Unidade_UnidadeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PacienteId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LeitoId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Internacaos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Internacaos_Leitos_LeitoId",
                        column: x => x.LeitoId,
                        principalTable: "Leitos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Internacaos_Pacientes_PacienteId",
                        column: x => x.PacienteId,
                        principalTable: "Pacientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Prontuairos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Prontuairos_Medicos_MedicoId",
                        column: x => x.MedicoId,
                        principalTable: "Medicos",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Prontuairos_Pacientes_PacienteId",
                        column: x => x.PacienteId,
                        principalTable: "Pacientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IssuedByProfessionalId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Receitas_Prontuairos_ProntuarioId",
                        column: x => x.ProntuarioId,
                        principalTable: "Prontuairos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Internacaos_LeitoId",
                table: "Internacaos",
                column: "LeitoId");

            migrationBuilder.CreateIndex(
                name: "IX_Internacaos_PacienteId",
                table: "Internacaos",
                column: "PacienteId");

            migrationBuilder.CreateIndex(
                name: "IX_Leitos_UnitId",
                table: "Leitos",
                column: "UnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prontuairos_MedicoId",
                table: "Prontuairos",
                column: "MedicoId");

            migrationBuilder.CreateIndex(
                name: "IX_Prontuairos_PacienteId",
                table: "Prontuairos",
                column: "PacienteId");
